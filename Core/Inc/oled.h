...
//本模块默认数据总线类型为4线制SPI
// OLED模块               STM32单片机
//   D1        接          PB5         //OLED屏SPI写信号
//=======================================液晶屏控制线接线==========================================//
// OLED模块               STM32单片机
//   CS          接          PB15        //OLED屏片选控制信号
//   RES         接          PB12        //OLED屏复位控制信号
//   DC          接          PB14        //OLED屏数据/命令选择控制信号
//   D0          接          PB3         //OLED屏SPI时钟信号
//=========================================触摸屏接线=========================================//
...
//-----------------OLED端口定义----------------
//#define OLED_CS   GPIO_Pin_15   //片选信号           PB15
//#define OLED_DC   GPIO_Pin_14   //数据/命令控制信号  PB14
//#define OLED_RST  GPIO_Pin_12   //复位信号           PB12

//-----------------OLED端口操作定义---------------- 
//#define OLED_CS_Clr()  GPIO_ResetBits(GPIOB,OLED_CS) //硬件自带CS，不需要操作
